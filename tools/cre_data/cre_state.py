...
def cre_state_pull(
    ...
    This function retrieves state-level Community Resilience Estimates data that measures 
    social vulnerability to disasters. The CRE tracks how socially vulnerable every 
    state is to the impacts of a disaster using 10 risk factors, providing 
    estimates for populations with 0, 1-2, and 3+ risk factors.

    Args:
        state_fips (List[str]): The FIPS code(s) for the state(s). 
                               List of strings (e.g., ["17"] or ["17", "26"])
...
if __name__ == "__main__":
    ...
    print(cre_state_pull(["17"], "2023"))
    # Multiple states example
    # print(cre_state_pull(["17", "26"], "2023"))  # Illinois and Michigan