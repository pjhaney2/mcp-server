...
def acs_housing_county_pull(
    ...
    This function is restricted to county-level housing characteristics data (DP04 profile only).
...
if __name__ == "__main__":
    print(acs_housing_county_pull("031", "17", "2018"))