...
def acs_demographics_place_pull(
    place_fips: List[str], 
    state_fips: str, 
    ...
    This function is restricted to place-level demographic data (DP05 profile only).
...
if __name__ == "__main__":
    ...
    print(acs_demographics_place_pull(["14000"], "17", "2018"))
    # Multiple places example
    # print(acs_demographics_place_pull(["14000", "51000"], "17", "2018"))