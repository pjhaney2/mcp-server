...
def acs_demographics_county_pull(
    geo_fips: List[str], 
    state_fips: str, 
    ...
    This function is restricted to county-level demographic data (DP05 profile only).
...
if __name__ == "__main__":
    ...
    print(acs_demographics_county_pull(["031"], "17", "2018"))
    # Multiple counties example
    # print(acs_demographics_county_pull(["031", "043"], "17", "2018"))