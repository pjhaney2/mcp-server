...
def acs_demographics_national_pull(
    year: Optional[str] = None
) -> Dict[str, Any]:
    """
    Pulls data from the US Census Bureau's American Community Survey (ACS) 5-year estimates.
    
    This function is restricted to national-level demographic data (DP05 profile only).
...
if __name__ == "__main__":
    ...
    print(acs_demographics_national_pull("2018"))