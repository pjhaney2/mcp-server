...
def acs_economic_msa_pull(
    ...
    This function is restricted to MSA/Micropolitan area-level economic characteristics data (DP03 profile only).
...
if __name__ == "__main__":
    print(acs_economic_msa_pull("16980", "2018"))