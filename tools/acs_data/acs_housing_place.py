...
def acs_housing_place_pull(
    ...
    This function is restricted to place-level housing characteristics data (DP04 profile only).
...
if __name__ == "__main__":
    print(acs_housing_place_pull("14000", "17", "2018"))