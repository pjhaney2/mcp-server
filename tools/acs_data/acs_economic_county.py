...
def acs_economic_county_pull(
    ...
    This function is restricted to county-level economic characteristics data (DP03 profile only).
    ...
    try:
        ...
        if not isinstance(geo_fips, str) or not geo_fips.isdigit():
            return _error_response("geo_fips must be a string of digits.")
...
if __name__ == "__main__":
    print(acs_economic_county_pull("031", "17", "2018"))